<ul class="nav digishiksha-navbar-header nav-line tx-12" id="myTab5" role="tablist">
    <li class="nav-item">
        <a class="nav-link active" href="{{url('/MasterAdmin/Transport/index')}}"><i class="fa fa-chart-line"></i> STOCK ANALYTICS</a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        ...
        <div class="dropdown-menu navbar-menu-sub tx-11 pd-0 pd-t-5">
            <a href="{{url('MasterAdmin/Attendance/DefineAttendanceSetting')}}" class="dropdown-item">DEFINE ATTENDANCE SETTING</a>
        </div>
    </li>
</ul>
