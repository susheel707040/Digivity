...
@endphp
<select @if(isset($id)) id="{{$id}}" @else id="timezone" @endif @if(isset($class)) class="{{$class}}" @else class="form-control input-sm" @endif
@if(isset($required)){{$required}}@endif @if(isset($name)) name="{{$name}}" @else name="timezone" @endif >
    <option value="">---Select---</option>
    @foreach($timezones as $value=>$key)
