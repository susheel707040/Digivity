...
@section('content')
    ...
    <form action="{{url('MasterAdmin/StudentInformation/StudentCreate')}}" data-parsley-validate="" novalidate="" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
    <div class="panel panel-default">
        <div class="panel-heading"><b><i class="fa fa-user-plus"></i> Student Registration</b></div>
            ...
            <div class="row pd-0 m-0">
                ...
                <div class="col-lg-8 m-0 pd-l-0 pd-r-0 vhr">
                    <ul class="nav nav-line tx-12 bg-light pd-l-5" id="myTab5" role="tablist">
                        ...
                        <li class="nav-item"><a class="nav-link" id="contact-tab5" data-toggle="tab" href="#other_info" role="tab" aria-controls="contact" aria-selected="false"> <i class="fa fa-list"></i> OTHER DETAILS</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="contact-tab5" data-toggle="tab" href="#document_info" role="tab" aria-controls="contact" aria-selected="false"> <i class="fa fa-sitemap"></i> DOCUMENTS DETAILS</a>
                        </li>
                    </ul>
                ...
                <div class="col-lg-1 pd-l-5 pd-r-0 vhr text-center">
                    <Center>
                    <button type="submit" class="btn btn-block btn-outline-success mg-t-20 rounded-pill">Save
                        <i class="fa fa-check"></i></button>
                        <a href="{{url('MasterAdmin/StudentInformation/ClassWiseStudentList')}}"><button type="button" class="btn btn-block btn-outline-primary tx-12 mg-t-20 rounded-pill">Preview <i class="fa fa-search"></i></button></a>
                       </Center>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript" src="{{url('assets/javascript/module/admission-js.js')}}"></script>
@endsection
