<form action="{{url('MasterAdmin/Transport/CreateVehicleType')}}" method="POST" enctype="multipart/form-data" id="selectForm2"
        ...
        <div class="row p-0 m-0">
            <div class="col-lg-6">
                ...
                <input type="text" id="vehicle_type" name="vehicle_type" autocomplete="off"
                       class="form-control input-sm" placeholder="Enter Vehicle Type">
            </div>
