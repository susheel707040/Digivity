<form action="{{url('MasterAdmin/Transport/CreateRoute')}}" method="POST" enctype="multipart/form-data" id="selectForm2"
        ...
        <div class="row p-0 m-0">
            ...
            <div class="col-lg-6">
                ...
                <input type="text" id="route" name="route" autocomplete="off"
                       class="form-control input-sm" placeholder="Enter Route">
            </div>
