<form action="{{url('MasterAdmin/Finance/CreateFeeHead')}}" method="POST" enctype="multipart/form-data"
      id="selectForm2"
        ...
        <div class="row p-0 m-0">
            <div class="col-lg-6">
                ...
                <input type="text" id="fee_head" name="fee_head" autocomplete="off"
                       class="form-control input-sm" placeholder="Enter Fee Account" required="">
            </div>
            <div class="col-lg-6">
                ...
                <input type="text" id="print_line_one" name="print_line_one" autocomplete="off"
                       class="form-control input-sm" placeholder="Enter Print line 1">
            </div>
            ...
            <div class="col-lg-6">
                ...
                <input type="text" id="print_line_two" name="print_line_two" autocomplete="off"
                       class="form-control input-sm" placeholder="Enter Print line 2">
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                <table cellspacing="0" cellpadding="0" class="p-0 mg-t-5">
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <table>
                                <tr>
                                    <td><input type="radio" id="refund" name="refund" value="yes"></td>
                                    <td class="pd-l-5">Yes</td>
                                    <td class="pd-l-5"><input type="radio" id="refund" name="refund" value="no" checked></td>
                        ...
                        <td class="pd-l-20">
                            <table>
                                <tr>
                                    <td><input type="radio" name="apply" value="yes" checked></td>
                                    <td class="pd-l-5">Yes</td>
                                    <td class="pd-l-5"><input type="radio" name="apply" value="no" ></td>
                                    <td class="pd-l-5">No</td>
                                </tr>
                            </table>
                        </td>
                        <td class="pd-l-20">
                            <table>
                                <tr>
                                    <td><input type="radio" id="refund" name="fee_custom" value="yes"></td>
                                    <td class="pd-l-5">Yes</td>
                                    <td class="pd-l-5"><input type="radio" id="refund" name="fee_custom" value="no" checked></td>
                                    <td class="pd-l-5">No</td>
                                </tr>
                            </table>
                        </td>
            ...
            <div class="col-lg-4">
                ...
                <table>
                    <tr>
                        <td><input type="radio" name="form_sale" value="yes"></td><td class="pd-l-5">Yes</td>
                        <td class="pd-l-5"><input type="radio" name="form_sale" value="no" checked></td><td class="pd-l-5">No</td>
                    </tr>
                </table>
            </div>
        </div>
