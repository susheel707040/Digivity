<form action="{{url('MasterAdmin/GlobalSetting/CreateSchoolBoard')}}" method="POST" enctype="multipart/form-data" id="selectForm2"
    ...
    <div class="modal-body pd-sm-t-0 pd-sm-b-20 pd-sm-x-5">
        ...
        <div class="row p-0 m-0">
            <div class="col-lg-6 form-group">
                ...
                <input type="text" id="board_name" name="board_name" autocomplete="off"
