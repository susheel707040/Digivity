...
@section('ModelTitle','Add New Nationality')
@section('ModelTitleInfo','Manage Nationality')
@section('EditModelTitle','Edit Nationality')
@section('EditModelTitleInfo','Modify Nationality')

@section('AddModelPage')
    @include('app.erpmodule.MasterAdmin.GlobalSetting.AcademicSetting.Add.add-nationality')
@endsection
...
@section('content')
    ...
    <div class="col-lg-10 mx-auto">
        <div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-list"></i> Nationality List</b></div>
                    ...
                    <div data-label="Example" class="df-example demo-table">
                        <table id="example2" class="table datatable table-bordered" >
                            ...
                            <tr>
                                ...
                                <th class="wd-25p">Nationality</th>
                            ...
                            @foreach($nationality as $data)
                                <tr editurl="{{url('MasterAdmin/GlobalSetting/EditViewNationality/'.$data->id.'/edit')}}" deleteurl="{{url('/RecordDelete/'.$data->id.'/'.$data->getTable().'/delete')}}">
