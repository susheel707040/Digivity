...
@section('ModelTitle','Add New House')
@section('ModelTitleInfo','Manage House')
@section('EditModelTitle','Edit House')
@section('EditModelTitleInfo','Modify House')

@section('AddModelPage')
    @include('app.erpmodule.MasterAdmin.GlobalSetting.AcademicSetting.Add.add-house')
@endsection
...
@section('content')
    ...
    <div class="col-lg-10 mx-auto">
        <div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-list"></i> House List</b></div>
                    ...
                    <div data-label="Example" class="df-example demo-table">
                        <table id="example2" class="table datatable table-bordered">
                            ...
                            @foreach($house as $data)
                                <tr editurl="{{url('MasterAdmin/GlobalSetting/EditViewHouse/'.$data->id.'/edit')}}"
