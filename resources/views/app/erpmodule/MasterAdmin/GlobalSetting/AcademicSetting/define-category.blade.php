...
@section('ModelTitle','Add New Category')
@section('ModelTitleInfo','Manage Category')
@section('EditModelTitle','Edit Category')
@section('EditModelTitleInfo','Modify Category')

@section('AddModelPage')
    @include('app.erpmodule.MasterAdmin.GlobalSetting.AcademicSetting.Add.add-category')
@endsection
...
@section('content')
    ...
    <div class="col-lg-10 mx-auto">
        <div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-list"></i> Category List</b></div>
                    ...
                    <div data-label="Example" class="df-example demo-table">
                        <table id="example2" class="table datatable table-bordered" >
                            ...
                            @foreach($category as $data)
                                <tr editurl="{{url('MasterAdmin/GlobalSetting/EditViewCategory/'.$data->id.'/edit')}}" deleteurl="{{url('/RecordDelete/'.$data->id.'/'.$data->getTable().'/delete')}}">
