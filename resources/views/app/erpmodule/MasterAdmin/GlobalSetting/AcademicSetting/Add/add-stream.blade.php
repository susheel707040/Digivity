<form action="{{url('MasterAdmin/GlobalSetting/CreateStream')}}" method="POST" enctype="multipart/form-data" id="selectForm2"
        ...
        <div class="row p-0 m-0">
            <div class="col-lg-6">
                ...
                <input type="text" id="stream" name="stream" autocomplete="off"
                       class="form-control input-sm" placeholder="Enter Stream (like : Science,Art,Commerce)" required>
            </div>
