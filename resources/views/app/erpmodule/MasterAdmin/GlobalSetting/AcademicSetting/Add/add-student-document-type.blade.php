<form action="{{url('MasterAdmin/StudentInformation/CreateStudentDocumentType')}}" method="POST" enctype="multipart/form-data" id="selectForm2"
    ...
    <div class="modal-body pd-sm-t-0 pd-sm-b-20 pd-sm-x-5">
        ...
        <div class="row p-0 m-0">
            <div class="col-lg-6">
                ...
                <input type="text" id="document_type" name="document_type" autocomplete="off"
                ...
                <table class="mg-t-35">
                    <tr>
                        ...
                        <td class="pd-l-10"><input type="radio" value="yes" name="mandatory"
                                   id="default_at"></td><td class="pd-l-3">Yes</td>
                        <td class="pd-l-10"><input type="radio" value="no" name="mandatory"
                                   id="default_at" checked></td><td class="pd-l-3" >No</td>
                    </tr>
                </table>
            </div>
        </div>
