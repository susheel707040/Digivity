<form action="{{url('MasterAdmin/GlobalSetting/CreateSubject')}}" method="POST" enctype="multipart/form-data" id="selectForm2"
        ...
        <div class="row p-0 m-0">
            <div class="col-lg-6">
                ...
                <input type="text" id="subject_name" name="subject_name" autocomplete="off"
                       class="form-control input-sm" placeholder="Enter Subject Name (like : English,Hindi,Mathematics)" required>
            </div>
            <div class="col-lg-6">
