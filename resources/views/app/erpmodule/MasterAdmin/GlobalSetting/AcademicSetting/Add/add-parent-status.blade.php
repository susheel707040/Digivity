<form action="{{url('MasterAdmin/GlobalSetting/CreateParentStatus')}}" method="POST" enctype="multipart/form-data" id="selectForm2"
        ...
        <div class="row p-0 m-0">
            <div class="col-lg-6">
                ...
                <input type="text" id="parent_status" name="parent_status" autocomplete="off"
                       class="form-control input-sm" placeholder="Enter Parent Status" required>
            </div>
