<form action="{{url('MasterAdmin/GlobalSetting/CreateCategory')}}" method="POST" enctype="multipart/form-data" id="selectForm2"
        ...
        <div class="row p-0 m-0">
            <div class="col-lg-6">
                ...
                <input type="text" id="category" name="category" autocomplete="off"
                       class="form-control input-sm" placeholder="Enter Category Name (Like : )" required>
            </div>
