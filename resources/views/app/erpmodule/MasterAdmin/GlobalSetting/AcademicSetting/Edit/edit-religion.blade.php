<form action="{{url('MasterAdmin/GlobalSetting/EditReligion/'.$religion->id.'/edit')}}" method="POST" enctype="multipart/form-data" id="selectForm2"
        ...
        <div class="row p-0 m-0">
            <div class="col-lg-6">
                ...
                <input type="text" id="religion" name="religion" autocomplete="off"
                     value="{{$religion->religion}}"  class="form-control input-sm" placeholder="Enter Religion">
            </div>

            <div class="col-lg-6">

                <label class="mg-t-35">Default Active <span class="text-gray">(Optional)</span> : <input type="checkbox" value="yes" name="default_at"
                                                                            @if($religion->default_at=="yes") checked @endif            id="default_at"></label>
            </div>
        </div>
    </div>
