<form action="{{url('MasterAdmin/Communication/CreatePhoneBookContact')}}" method="POST" enctype="multipart/form-data"
      id="selectForm2"
    ...
    <div class="modal-body pd-sm-t-0 pd-sm-b-20 pd-sm-x-5">
        ...
        <div class="row p-0 m-0">
            <div class="col-lg-4">
                ...
                <select name="group_id" id="group_id" class="form-control input-sm" required>
                    <option value="">---Select---</option>
                    @foreach(phonebookgrouplist() as $data)
                        <option value="{{$data->id}}">{{$data->phonebook_group}}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-lg-4">
                        ...
                        <td class="wd-20p">
                            <select name="title" id="title" class="form-control input-sm">
                                @foreach($title_name as $data)
                                    <option value="{{$data}}">{{\Illuminate\Support\Str::ucfirst($data)}}</option>
                                @endforeach
                            </select>
                        </td>
                        <td><input type="text" name="name" id="name" autocomplete="off" class="form-control input-sm"
            ...
            <div class="col-lg-4">
                ...
                <input type="text" id="contact_no" name="contact_no" autocomplete="off" class="form-control input-sm"
            ...
            <div class="col-lg-4">
                ...
                <input type="text" id="company" name="company" autocomplete="off" class="form-control input-sm"
                       placeholder="Enter Company Name">
            </div>

            <div class="col-lg-4">
                <label>Designation <span class="text-gray">(Optional)</span> :</label>
                <input type="text" name="designation" id="designation" autocomplete="off" class="form-control input-sm"
            ...
            <div class="col-lg-6">
                ...
                <table>
                    <tr>
                        <td><input type="radio" value="active" name="status" id="status" checked></td>
                        <td class="pd-l-5">Active</td>
                        <td class="pd-l-10"><input type="radio" value="inactive" name="status" id="status"></td>
