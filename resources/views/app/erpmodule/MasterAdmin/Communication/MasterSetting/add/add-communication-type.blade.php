<form action="{{url('MasterAdmin/Communication/CreateCommunicationType')}}" method="POST" enctype="multipart/form-data" id="selectForm2"
        ...
        <div class="row p-0 m-0">
            <div class="col-lg-6">
                ...
                <input type="text" id="communication_type" name="communication_type" autocomplete="off"
                       class="form-control input-sm" placeholder="Enter Communication Type" required>
            </div>
