<form action="{{url('MasterAdmin/Library/CreateLibrary')}}" method="POST" enctype="multipart/form-data" id="selectForm2"
        ...
        <div class="row p-0 m-0">
            <div class="col-lg-6">
                ...
                <input type="text" id="library_name" name="library_name" autocomplete="off"
                       class="form-control input-sm" placeholder="Enter Library Name" required="">
            </div>
            ...
            <div class="col-lg-6">
                ...
                <textarea class="form-control" id="address" name="address" placeholder="Enter Library Address"></textarea>
            </div>
            ...
            <div class="col-lg-6">
                ...
                <table>
                    <tr>
                        <td><input type="radio" name="default_at" value="yes" ></td><td class="pd-l-5">Yes</td>
                        <td class="pd-l-10"><input type="radio" name="default_at" value="no" checked></td><td class="pd-l-5">No</td>
                    </tr>
                </table>
            </div>
