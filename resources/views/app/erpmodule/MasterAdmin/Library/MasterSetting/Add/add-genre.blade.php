<form action="{{url('MasterAdmin/Library/CreateGenres')}}" method="POST" enctype="multipart/form-data" id="selectForm2"
        ...
        <div class="row p-0 m-0">
            <div class="col-lg-6">
                ...
                <input type="text" id="genre" name="genre" autocomplete="off"
                       class="form-control input-sm" placeholder="Enter Genres" required="">

                <a target="_blank" loader-disable="true" href="{{url('images/Genres-of-Books.jpg')}}"><span class="tx-9"><u>Genres Example See </u></span></a>
            </div>
