<form action="{{url('MasterAdmin/Library/CreateTag')}}" method="POST" enctype="multipart/form-data" id="selectForm2"
        ...
        <div class="row p-0 m-0">
            <div class="col-lg-6">
                ...
                <input type="text" id="tag" name="tag" autocomplete="off"
                       class="form-control input-sm" placeholder="Enter Tag" required="">
            </div>
