<form action="{{url('MasterAdmin/Library/CreateRacks')}}" method="POST" enctype="multipart/form-data" id="selectForm2"
        ...
        <div class="row p-0 m-0">
            <div class="col-lg-6">
                ...
                <input type="text" id="racks" name="racks" autocomplete="off"
                       class="form-control input-sm" placeholder="Enter Racks" required="">
            </div>

            <div class="col-lg-6">
                <label>Capacity <span class="text-gray">(Optional)</span> : </label>
                <input type="text" id="capacity" name="capacity" autocomplete="off"
                       class="form-control input-sm" placeholder="Enter Capacity">
            </div>
