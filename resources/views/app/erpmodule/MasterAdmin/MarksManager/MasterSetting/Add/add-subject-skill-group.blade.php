<form action="{{url('MasterAdmin/MarksManager/StoreExamSubjectSkillGroup')}}" method="POST"
    ...
    <div class="modal-body pd-sm-t-0 pd-sm-b-20 pd-sm-x-5">
        ...
        <div class="row p-0 m-0">
            <div class="col-lg-6">
                ...
                <input type="text" id="skill_group_name" name="skill_group_name" autocomplete="off"
