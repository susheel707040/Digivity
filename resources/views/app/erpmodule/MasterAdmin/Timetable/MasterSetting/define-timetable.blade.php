...
@section('ModelTitle','Add New Timetable')
@section('ModelTitleInfo','Manage Timetable')
@section('EditModelTitle','Edit Timetable')
@section('EditModelTitleInfo','Modify Timetable')

@section('AddModelPage')
    @include('app.erpmodule.MasterAdmin.Timetable.MasterSetting.Add.add-timetable')
@endsection
...
@section('content')
    ...
    <div class="col-lg-10 mx-auto">
        <div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-list"></i> Timetable List</b></div>
                    ...
                    <div data-label="Example" class="df-example demo-table">
                        <table id="example2" class="table datatable table-bordered" >
                            ...
                            @foreach($timetable as $data)
                                <tr editurl="{{url('/MasterAdmin/Timetable/EditViewTimetable/'.$data->id.'/editview')}}" deleteurl="{{url('/RecordDelete/'.$data->id.'/'.$data->getTable().'/delete')}}">
