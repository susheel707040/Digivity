...
@section('content')
    ...
    <form action="{{url('MasterAdmin/Staff/CreateStaff')}}" data-parsley-validate="" novalidate="" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
        <div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-user-plus"></i> Staff/Employee Registration</b></div>
                        ...
                        <ul class="nav nav-line tx-12 bg-light pd-l-5" id="myTab5" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="student-info" data-toggle="tab" href="#staff_info"
                                   role="tab"
                                   aria-controls="contact" aria-selected="true"><i class="fa fa-user"></i> STAFF/EMPLOYEE
                                    DETAILS</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="parent-info" data-toggle="tab" href="#qualification_info" role="tab"
                                   aria-controls="contact" aria-selected="false"><i class="fa fa-graduation-cap"></i> QUALIFICATION DETAILS</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="parent-info" data-toggle="tab" href="#document_info" role="tab"
                                   aria-controls="contact" aria-selected="false"><i class="fa fa-file-pdf"></i> DOCUMENT DETAILS</a>
                            </li>
                            <li class="nav-item">
