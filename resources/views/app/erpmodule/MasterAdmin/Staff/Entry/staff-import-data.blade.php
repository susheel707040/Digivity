...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-style1 mg-b-10">
            ...
            <li class="breadcrumb-item active" aria-current="page">Staff/Employee</li>
            <li class="breadcrumb-item active" aria-current="page">Import Staff Data</li>
        </ol>
    </nav>
    <div class="col-lg-12 p-0 m-0">
        <div class="panel panel-default">
            <div class="panel-heading"><b><i class="fa fa-file-import"></i> Import Staff Data</b></div>
            <div class="panel-body pd-b-0 row">
                <form class="container-fluid" action="{{url('MasterAdmin/Staff/StaffImportView')}}" method="POST" enctype="multipart/form-data" data-parsley-validate="" novalidate="">
                    {{csrf_field()}}
                    <div class="col-lg-8 mx-auto pd-b-20 pd-t-10">
                        ...
                        <div class="col-lg-12 mg-t-30">
                            <a href="{{url('ImportFileFormat/StaffFullDetailImport.xlsx')}}" download="" loader-disable="true" class="text-danger cursor-pointer tx-14"><u><i class="fa fa-file-excel"></i> Staff/Employee Full Record Import Format</u></a>
                            <a href="{{url('ImportFileFormat/StudentShortImport.xlsx')}}" download="" loader-disable="true" class="text-danger cursor-pointer float-right tx-14"><u><i class="fa fa-file-excel"></i> Staff/Employee Short Record Import Format</u></a>
                        </div>
