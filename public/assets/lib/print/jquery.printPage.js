        ...
        function addIframeToPage(el, pluginOptions){
            ...
            if(!$('#printPage')[0]){
                ...
                $('#printPage').on("load",function() {
                    var myFrame = $("#printPage").contents().find('div.bodydata');
                    var myFrameCss=$("#printPage").contents().find('div.stylesheet');
                    var datatable = $(".datatable").html();
                    var stylesheet="<style>table{ background-color: red; border:1px solid silver;}</style>";
                    myFrame.html("<table class='tabledata' cellspacing='0' cellpadding='2'>"+datatable+"</table>");
                    printit();
                })
            }else{
